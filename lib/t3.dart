      ...
      body: Center(
        ...
        children: [
          ...
          Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: "Ingrese su departamento asignado",
                    labelText: "Edepartamento",
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: Colors.red)),
                    focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: Colors.blue)),
          ...
          Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: "Ingrese el numero telefonico",
                    labelText: "Telefono",
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: Colors.red)),
                    focusedBorder: OutlineInputBorder(
